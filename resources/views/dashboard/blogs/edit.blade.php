                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-colored-form-control">  تعديل المقال : {{ $blog->title }}   </h4>
                                ...
                                <form class="form" method="post"
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <label>الموضوع</label>
                                                <textarea name="body" class="form-control ckeditor" required >{{ $blog->body }}</textarea>
