                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">القيم والمباديء </h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form style="display: inline"
                                                            action="{{ route('principles.destroy', $item->id) }}"
                                                            method="post">
                                                            @method('delete') @csrf
                                                    ...
                                                    <form action="{{ route('principles.store') }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group col-md-8">
                                                            ...
                                                            <input type="text" name="body" class="form-control"
                                                                required placeholder="اضف الوصف" id="email">
                                                        </div>
    ...
    <div class="modal" id="updateStore">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title"> تعديل المباديء</h4>
                    <button type="button" class="close"
                        data-dismiss="modal">&times;</button>
                </div>
