            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{ route('dashboard') }}">
                        {{-- <img src="{{ asset('uploads/'.get_general_value('image')) }}" alt=""> --}}
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list w-100 ps-container ps-theme-dark"
                                data-ps-id="0aa33947-2a90-7244-da0a-58037619abb6" id="data_notify">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <small>
                                                    ...
                                                    <time class="media-meta text-muted"
                                                        datetime="2015-06-11T18:29:20+08:00">{{ \Carbon\Carbon::parse($item->data['time'])->diffForhumans() }}</time>
                                                </small>
                                            </div>
                                        </div>
                                    </a>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                    id="read_notofication" href="javascript:void(0)">@lang('Read all notifications')</a></li>
                        </ul>
                    </li>
