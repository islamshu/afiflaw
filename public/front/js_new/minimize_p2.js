...
(function(theme, $) {
    ...
    PluginCarousel.prototype = {
        ...
        setOptions: function(opts) { this.options = $.extend(true, {}, PluginCarousel.defaults, opts, { wrapper: this.$el }); return this; },
        build: function() {
            ...
            if ($('html').attr('dir') == 'rtl') { this.options = $.extend(true, {}, this.options, { rtl: true }); }
            ...
            if (this.options.autoHeight) {
                $(window).afterResize(function() { $el.find('.owl-stage-outer').height($el.find('.owl-item.active').height()); });
                $(window).load(function() { $el.find('.owl-stage-outer').height($el.find('.owl-item.active').height()); });
            }
            $el.on('initialized.owl.carousel', function(event) { OwlCarousel_FixRenderIssuer($el); });
...
(function(theme, $) {
    ...
    PluginCounter.prototype = {
        ...
        setData: function() { this.$el.data(instanceName, this); return this; },
        setOptions: function(opts) { this.options = $.extend(true, {}, PluginCounter.defaults, opts, { wrapper: this.$el }); return this; },
        build: function() {
    ...
    $(document).on('s123.page.ready', function(event) {
        ...
        if (layoutNUM != '2' && layoutNUM != '15' && layoutNUM != '3' && layoutNUM != '11' && layoutNUM != '4' && layoutNUM != '20') {
            if ($('.home_page:not(.rich_page)').length > 0) {
                ...
                if (layoutNUM == '13') { fixedMenuAfterFirstScroll += parseInt($('#mainNav').css('margin-top'), 10); }
                if (fixedMenuAfterFirstScroll == 0) { fixedMenuAfterFirstScroll = 1; }
            } else { var fixedMenuAfterFirstScroll = parseInt($('body').css('margin-top'), 10); }
            setStickyMenuHandler.init({ $mainNav: $('#mainNav'), offSetTop: fixedMenuAfterFirstScroll });
            if ($('.inside_page').length == 0) { var HighlightMenuOnScrollOffset = $('#mainNav').height() + parseInt($('body').css('margin-top'), 10); } else { var HighlightMenuOnScrollOffset = parseInt($('body').css('margin-top'), 10); }
            $('body').scrollspy({ target: '#mainNav', offset: HighlightMenuOnScrollOffset });
            ...
            $(window).resize(function() { ReduseMenuSizeWhenWeDontHavePlace(); });
        }
    });
});
jQuery(function($) {
    $(document).on('s123.page.ready', function(event) {
        ...
        if (layoutNUM == '2') {
            ...
            $('body').scrollspy({ target: '#mainNav #top-menu', offset: beforeScrollMenuHeight });
            setStickyMenuHandler.init({ $mainNav: $('#mainNav #top-menu'), offSetTop: beforeScrollMenuHeight });
            if (typeof document.fonts === 'undefined' || typeof document.fonts.ready === 'undefined' || typeof document.fonts.ready.then === 'undefined') { setTimeout(function() { ReduseMenuSizeWhenWeDontHavePlace(); }, 150); } else { document.fonts.ready.then(function() { ReduseMenuSizeWhenWeDontHavePlace(); }); }
            $(window).resize(function() { ReduseMenuSizeWhenWeDontHavePlace(); });
        }
    });
...
jQuery(function($) {
    $(document).on('s123.page.ready', function(event) {
        var layoutNUM = $('#layoutNUM').val();
        if (layoutNUM == '15') {
            if ($('.home_page:not(.rich_page)').length > 0) { var fixedMenuAfterFirstScroll = $(window).height() - $('#mainNav').height(); } else { var fixedMenuAfterFirstScroll = 0; }
            setStickyMenuHandler.init({ $mainNav: $('#mainNav'), offSetTop: fixedMenuAfterFirstScroll });
            if ($('.home_page:not(.rich_page)').length > 0) {
                $('#mainNav').off('affix.bs.affix').on('affix.bs.affix', function() { $('.navbar-fixed-top').css({ position: 'fixed', bottom: 'auto', top: '0' }); });
                $('#mainNav').off('affix-top.bs.affix').on('affix-top.bs.affix', function() { $('.navbar-fixed-top').css({ position: 'absolute', bottom: '0', top: 'auto' }); });
            } else { $('.navbar-fixed-top').css({ position: '', bottom: '', top: '' }); }
            $('body').scrollspy({ target: '#mainNav', offset: $('#mainNav').height() });
            if (typeof document.fonts === 'undefined' || typeof document.fonts.ready === 'undefined' || typeof document.fonts.ready.then === 'undefined') { setTimeout(function() { ReduseMenuSizeWhenWeDontHavePlace(); }, 150); } else { document.fonts.ready.then(function() { ReduseMenuSizeWhenWeDontHavePlace(); }); }
            $(window).resize(function() { ReduseMenuSizeWhenWeDontHavePlace(); });
        }
    });
...
jQuery(function($) {
    $(document).on('s123.page.ready', function(event) {
        var layoutNUM = $('#layoutNUM').val();
        if (layoutNUM == '20') {
            if (!window.layout20_topMenuHeight) { window.layout20_topMenuHeight = $('#mainNav').outerHeight(); }
            ...
            setStickyMenuHandler.init({ $mainNav: $('#mainNav'), offSetTop: beforeScrollMenuHeight });
            if ($('.home_page:not(.rich_page)').length > 0) {
                $('#mainNav').off('affix.bs.affix').on('affix.bs.affix', function() { $('.navbar-fixed-top').css({ position: 'fixed', bottom: 'auto', top: '0' }); });
                $('#mainNav').off('affix-top.bs.affix').on('affix-top.bs.affix', function() { $('.navbar-fixed-top').css({ position: 'absolute', bottom: -Math.abs(window.layout20_topMenuHeight), top: 'auto' }); });
            } else { $('.navbar-fixed-top').css({ 'position': '', 'bottom': '', 'top': '' }); }
            if (typeof document.fonts === 'undefined' || typeof document.fonts.ready === 'undefined' || typeof document.fonts.ready.then === 'undefined') { setTimeout(function() { ReduseMenuSizeWhenWeDontHavePlace(); }, 150); } else { document.fonts.ready.then(function() { ReduseMenuSizeWhenWeDontHavePlace(); }); }
            $(window).resize(function() { ReduseMenuSizeWhenWeDontHavePlace(); });
        }
...
jQuery(function($) {
    $(document).on('s123.page.ready', function(event) {
        ...
        if (layoutNUM == '3' || layoutNUM == '11') {
            if (layoutNUM == '3') { $("#header").toggleClass('side-menu-slide'); }
            ...
            $('#header #top-menu li').not('.dropdown-submenu').find('a').off('click').click(function() { $("#menu-toggle").click(); });
            if (typeof document.fonts === 'undefined' || typeof document.fonts.ready === 'undefined' || typeof document.fonts.ready.then === 'undefined') { setTimeout(function() { ReduseMenuSizeWhenWeDontHavePlaceHeight(); }, 150); } else { document.fonts.ready.then(function() { ReduseMenuSizeWhenWeDontHavePlaceHeight(); }); }
            $(window).resize(function() { ReduseMenuSizeWhenWeDontHavePlaceHeight(); });
        }
    });
});

function layout3_changeBarsIcon() { if ($("#header").hasClass('active')) { $("#menu-toggle").find('.fa').removeClass('fa-bars').addClass('fa-close'); } else { $("#menu-toggle").find('.fa').removeClass('fa-close').addClass('fa-bars'); } }
jQuery(function($) {
    $(document).on('s123.page.ready', function(event) {
        var layoutNUM = $('#layoutNUM').val();
        if (layoutNUM == '4') {
...
jQuery(function($) { CarouselModuleInitialize(); });

function CarouselModuleInitialize() {
    $(document).on('s123.page.ready', function(event) {
        var $sections = $('.s123-module-carousel');
        $sections.each(function(index) { var $s = $(this); var categories = new ModuleLayoutCategories({ $items: $s.find('.carousel-category'), $categoriesContainer: $s.find('.categories-panel'), $filterButton: $s.find('.items-responsive-filter'), $categories: $s.find('.items-categories-container li') }); });
        if ($.isFunction($.fn['themePluginCarousel'])) {
            $sections.find('.owl-carousel.manual').each(function() {
                ...
                $this.themePluginCarousel(opts);
                if (!$this.is(':visible')) { $this.addClass('owl-hidden'); }
            });
        }
    });
}

function OwlCarousel_FixRenderIssuer($el) { setTimeout(function() { $el.css({ visibility: 'visible' }); }, 600); }! function(t, e) { "function" == typeof define && define.amd ? define("jquery-bridget/jquery-bridget", ["jquery"], function(i) { return e(t, i) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("jquery")) : t.jQueryBridget = e(t, t.jQuery) }(window, function(t, e) {
    "use strict";
...
function(t, e) {
    ...
    function h(t, e) {
        ...
        if (this.element = i, this.element.flickityGUID) { var s = f[this.element.flickityGUID]; return s.option(e), s }
...
function(t, e) { "function" == typeof define && define.amd ? define("unipointer/unipointer", ["ev-emitter/ev-emitter"], function(i) { return e(t, i) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("ev-emitter")) : t.Unipointer = e(t, t.EvEmitter) }(window, function(t, e) {
    ...
    }, s.ontouchstart = function(t) { this._pointerDown(t, t.changedTouches[0]) }, s.onpointerdown = function(t) { this._pointerDown(t, t) }, s._pointerDown = function(t, e) { this.isPointerDown || (this.isPointerDown = !0, this.pointerIdentifier = void 0 !== e.pointerId ? e.pointerId : e.identifier, this.pointerDown(t, e)) }, s.pointerDown = function(t, e) { this._bindPostStartEvents(t), this.emitEvent("pointerDown", [t, e]) };
    ...
    }, s._pointerMove = function(t, e) { this.pointerMove(t, e) }, s.pointerMove = function(t, e) { this.emitEvent("pointerMove", [t, e]) }, s.onmouseup = function(t) { this._pointerUp(t, t) }, s.onpointerup = function(t) { t.pointerId == this.pointerIdentifier && this._pointerUp(t, t) }, s.ontouchend = function(t) {
        var e = this.getTouch(t.changedTouches);
...
function(t, e) { "function" == typeof define && define.amd ? define("flickity/js/drag", ["./flickity", "unidragger/unidragger", "fizzy-ui-utils/utils"], function(i, n, s) { return e(t, i, n, s) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("./flickity"), require("unidragger"), require("fizzy-ui-utils")) : t.Flickity = e(t, t.Flickity, t.Unidragger, t.fizzyUIUtils) }(window, function(t, e, i, n) {
    ...
    return r.canPreventDefaultOnPointerDown = function(t) { var e = s(t); return !e }, r.hasDragStarted = function(t) { return Math.abs(t.x) > this.options.dragThreshold }, r.pointerUp = function(t, e) { delete this.isTouchScrolling, this.viewport.classList.remove("is-pointer-down"), this.dispatchEvent("pointerUp", t, [e]), this._dragPointerUp(t, e) }, r.pointerDone = function() { t.removeEventListener("scroll", this), delete this.pointerDownScroll }, r.dragStart = function(e, i) { this.dragStartPosition = this.x, this.startAnimation(), t.removeEventListener("scroll", this), this.dispatchEvent("dragStart", e, [i]) }, r.pointerMove = function(t, e) {
        var i = this._dragPointerMove(t, e);
        ...
        return s
    }, r._getClosestResting = function(t, e, i) { for (var n = this.selectedIndex, s = 1 / 0, o = this.options.contain && !this.options.wrapAround ? function(t, e) { return t <= e } : function(t, e) { return t < e }; o(e, s) && (n += i, s = e, e = this.getSlideDistance(-t, n), null !== e);) e = Math.abs(e); return { distance: s, index: n - i } }, r.getSlideDistance = function(t, e) {
        var i = this.slides.length,
...
function(t, e) { "function" == typeof define && define.amd ? define("flickity-as-nav-for/as-nav-for", ["flickity/js/index", "fizzy-ui-utils/utils"], e) : "object" == typeof module && module.exports ? module.exports = e(require("flickity"), require("fizzy-ui-utils")) : t.Flickity = e(t.Flickity, t.fizzyUIUtils) }(window, function(t, e) {
    ...
    return n._createAsNavFor = function() {
        ...
        if (n && n != this) {
            this.navCompanion = n;
            var s = this;
            this.onNavCompanionSelect = function() { s.navCompanionSelect() }, n.on("select", this.onNavCompanionSelect), this.on("staticClick", this.onNavStaticClick), this.navCompanionSelect(!0)
        }
...
function AboutModuleInitialize_Layout2_4_14() {
    $(document).on('s123.page.ready', function(event) {
        ...
        $section.each(function(index) {
            ...
            $flickityContainer.find('.carousel-cell').imagesLoaded({ background: true }, function(imgLoad) {
                var $img = null;
                for (var i = 0; i < imgLoad.images.length; i++) { var $imgParent = $(imgLoad.images[i].element); if ($flickityContainer.find('.carousel-cell').index($imgParent) == 0) { $img = $(imgLoad.images[0].img); break; } }
                $img.css({ visibility: 'hidden', position: 'absolute', top: 0 });
                $('body').prepend($img);
                ...
                $flickityContainer.flickity({ imagesLoaded: true, lazyLoad: 2, pageDots: false, wrapAround: true, percentPosition: false });
            });
    ...
    function resizeGalleryImages(originalImageSize, containerWidth, $galleryItems) {
        if (originalImageSize.width > originalImageSize.height) { var ratio = originalImageSize.width / originalImageSize.height; } else { var ratio = originalImageSize.height / originalImageSize.width; }
        $galleryItems.css({ width: containerWidth, height: containerWidth / ratio });
    }
}
jQuery(function($) { AboutModuleInitialize_Layout9(); });
...
jQuery(function($) { aboutModuleInitialize_Layout10(); });
...
jQuery(function($) { ContactModuleInitialize(); });
...
function ContactModuleInitialize() {
    $(document).on('s123.page.ready', function(event) {
        ...
        $section.each(function(index) {
            var $sectionThis = $(this);
            if (false) { buisnessHoursTemplate.init({ $buisnessHourContainer: $sectionThis.find('#businessWorkingDays'), buisnessHourJSON: $sectionThis.find("#businessHours") }); }
            $sectionThis.find('.contactUsForm').each(function(index) {
                ...
                $form.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        if ($form.data('thanks-msg')) { thankYouMessage = $form.data('thanks-msg'); }
        ...
        MC.$categories.off('click').on('click', function(event, initialize) {
            ...
            if (initialize) {
                ...
                MC.$items.fadeOut(200).promise().done(function() {
                    $filtered.fadeIn(200, function() { $category.closest('section').trigger('module_layout_categories.shown', [$category.data('categories-filter')]); });
                    $category.closest('section').trigger('module_layout_categories.show', [$category.data('categories-filter')]);
...
function TimelineModuleInitialize() {
    $(document).on('s123.page.ready', function(event) {
        ...
        $section.each(function(index) {
            var $sectionThis = $(this);
            var categories = new ModuleLayoutCategories({ $items: $sectionThis.find('.timeline-category'), $categoriesContainer: $sectionThis.find('.categories-panel'), $filterButton: $sectionThis.find('.items-responsive-filter'), $categories: $sectionThis.find('.items-categories-container li') });
...
function(a) {
    ...
    FlipClock.List = FlipClock.Base.extend({
        ...
        items: [],
        lastDigit: 0,
        constructor: function(a, b) { this.factory = a, this.digit = b, this.lastDigit = b, this.$el = this.createList(), this.$obj = this.$el, b > 0 && this.select(b), this.factory.$el.append(this.$el) },
        select: function(a) {
...
function(a) {
    ...
    FlipClock.Time = FlipClock.Base.extend({
        ...
        removeLeadingZeros: function(b, c) {
            var d = 0,
                e = [];
            return a.each(c, function(a) { b > a ? d += parseInt(c[a], 10) : e.push(c[a]) }), 0 === d ? e : c
        },
...
function() { FlipClock.MinuteCounterFace = FlipClock.HourlyCounterFace.extend({ clearExcessDigits: !1, constructor: function(a, b) { this.base(a, b) }, build: function() { this.base(!0, this.factory.time.getMinuteCounter()) }, flip: function(a, b) { a || (a = this.factory.time.getMinuteCounter()), this.base(a, b) } }) }(jQuery),
function(a) {
...
function() { FlipClock.Lang.Arabic = { years: "ط³ظ†ظˆط§طھ", months: "ط´ظ‡ظˆط±", days: "ط£ظٹط§ظ…", hours: "ط³ط§ط¹ط§طھ", minutes: "ط¯ظ‚ط§ط¦ظ‚", seconds: "ط«ظˆط§ظ†ظٹ" }, FlipClock.Lang.ar = FlipClock.Lang.Arabic, FlipClock.Lang["ar-ar"] = FlipClock.Lang.Arabic, FlipClock.Lang.arabic = FlipClock.Lang.Arabic }(jQuery),
function() { FlipClock.Lang.Danish = { years: "أ…r", months: "Mأ¥neder", days: "Dage", hours: "Timer", minutes: "Minutter", seconds: "Sekunder" }, FlipClock.Lang.da = FlipClock.Lang.Danish, FlipClock.Lang["da-dk"] = FlipClock.Lang.Danish, FlipClock.Lang.danish = FlipClock.Lang.Danish }(jQuery),
function() { FlipClock.Lang.German = { years: "Jahre", months: "Monate", days: "Tage", hours: "Stunden", minutes: "Minuten", seconds: "Sekunden" }, FlipClock.Lang.de = FlipClock.Lang.German, FlipClock.Lang["de-de"] = FlipClock.Lang.German, FlipClock.Lang.german = FlipClock.Lang.German }(jQuery),
function() { FlipClock.Lang.English = { years: "Years", months: "Months", days: "Days", hours: "Hours", minutes: "Minutes", seconds: "Seconds" }, FlipClock.Lang.en = FlipClock.Lang.English, FlipClock.Lang["en-us"] = FlipClock.Lang.English, FlipClock.Lang.english = FlipClock.Lang.English }(jQuery),
function() { FlipClock.Lang.Spanish = { years: "A&#241;os", months: "Meses", days: "D&#205;as", hours: "Horas", minutes: "Minutos", seconds: "Segundo" }, FlipClock.Lang.es = FlipClock.Lang.Spanish, FlipClock.Lang["es-es"] = FlipClock.Lang.Spanish, FlipClock.Lang.spanish = FlipClock.Lang.Spanish }(jQuery),
function() { FlipClock.Lang.Finnish = { years: "Vuotta", months: "Kuukautta", days: "Pأ¤ivأ¤أ¤", hours: "Tuntia", minutes: "Minuuttia", seconds: "Sekuntia" }, FlipClock.Lang.fi = FlipClock.Lang.Finnish, FlipClock.Lang["fi-fi"] = FlipClock.Lang.Finnish, FlipClock.Lang.finnish = FlipClock.Lang.Finnish }(jQuery),
function() { FlipClock.Lang.French = { years: "Ans", months: "Mois", days: "Jours", hours: "Heures", minutes: "Minutes", seconds: "Secondes" }, FlipClock.Lang.fr = FlipClock.Lang.French, FlipClock.Lang["fr-ca"] = FlipClock.Lang.French, FlipClock.Lang.french = FlipClock.Lang.French }(jQuery),
function() { FlipClock.Lang.Italian = { years: "Anni", months: "Mesi", days: "Giorni", hours: "Ore", minutes: "Minuti", seconds: "Secondi" }, FlipClock.Lang.it = FlipClock.Lang.Italian, FlipClock.Lang["it-it"] = FlipClock.Lang.Italian, FlipClock.Lang.italian = FlipClock.Lang.Italian }(jQuery),
function() { FlipClock.Lang.Latvian = { years: "Gadi", months: "Mؤ“neإ،i", days: "Dienas", hours: "Stundas", minutes: "Minإ«tes", seconds: "Sekundes" }, FlipClock.Lang.lv = FlipClock.Lang.Latvian, FlipClock.Lang["lv-lv"] = FlipClock.Lang.Latvian, FlipClock.Lang.latvian = FlipClock.Lang.Latvian }(jQuery),
function() { FlipClock.Lang.Dutch = { years: "Jaren", months: "Maanden", days: "Dagen", hours: "Uren", minutes: "Minuten", seconds: "Seconden" }, FlipClock.Lang.nl = FlipClock.Lang.Dutch, FlipClock.Lang["nl-be"] = FlipClock.Lang.Dutch, FlipClock.Lang.dutch = FlipClock.Lang.Dutch }(jQuery),
function() { FlipClock.Lang.Norwegian = { years: "أ…r", months: "Mأ¥neder", days: "Dager", hours: "Timer", minutes: "Minutter", seconds: "Sekunder" }, FlipClock.Lang.no = FlipClock.Lang.Norwegian, FlipClock.Lang.nb = FlipClock.Lang.Norwegian, FlipClock.Lang["no-nb"] = FlipClock.Lang.Norwegian, FlipClock.Lang.norwegian = FlipClock.Lang.Norwegian }(jQuery),
function() { FlipClock.Lang.Portuguese = { years: "Anos", months: "Meses", days: "Dias", hours: "Horas", minutes: "Minutos", seconds: "Segundos" }, FlipClock.Lang.pt = FlipClock.Lang.Portuguese, FlipClock.Lang["pt-br"] = FlipClock.Lang.Portuguese, FlipClock.Lang.portuguese = FlipClock.Lang.Portuguese }(jQuery),
function() { FlipClock.Lang.Russian = { years: "ذ»ذµر‚", months: "ذ¼ذµرپرڈر†ذµذ²", days: "ذ´ذ½ذµذ¹", hours: "ر‡ذ°رپذ¾ذ²", minutes: "ذ¼ذ¸ذ½رƒر‚", seconds: "رپذµذ؛رƒذ½ذ´" }, FlipClock.Lang.ru = FlipClock.Lang.Russian, FlipClock.Lang["ru-ru"] = FlipClock.Lang.Russian, FlipClock.Lang.russian = FlipClock.Lang.Russian }(jQuery),
function() { FlipClock.Lang.Swedish = { years: "أ…r", months: "Mأ¥nader", days: "Dagar", hours: "Timmar", minutes: "Minuter", seconds: "Sekunder" }, FlipClock.Lang.sv = FlipClock.Lang.Swedish, FlipClock.Lang["sv-se"] = FlipClock.Lang.Swedish, FlipClock.Lang.swedish = FlipClock.Lang.Swedish }(jQuery),
function() { FlipClock.Lang.Chinese = { years: "ه¹´", months: "وœˆ", days: "و—¥", hours: "و—¶", minutes: "هˆ†", seconds: "ç§’" }, FlipClock.Lang.zh = FlipClock.Lang.Chinese, FlipClock.Lang["zh-cn"] = FlipClock.Lang.Chinese, FlipClock.Lang.chinese = FlipClock.Lang.Chinese }(jQuery);
    ...
    $(document).on('s123.page.ready', function(event) {
        ...
        $($section).each(function(index) {
            ...
            if ($shapeTop.length > 0) {
                ...
                if ($.isNumeric(topShapeSize)) { $sectionThis.find('.shapeTop').css('height', 'calc(' + topShapeSize + '% + 5px)'); }
                if (topShapeHideFromMobile == 'on') { $sectionThis.find('.shapeTop').attr('class', $sectionThis.find('.shapeTop').attr('class') + ' hideFromMobile'); }
                if (topShapeColor.length > 0) { $sectionThis.find('.shapeTop').css('fill', topShapeColor); } else {
                    $sectionThis.find('.shapeTop').css('fill', GetShapeColor('top', $sectionThis.attr('id')));
                    $(document).on('s123.page.ready.refreshPageOrder', function(event) { $sectionThis.find('.shapeTop').css('fill', GetShapeColor('top', $sectionThis.attr('id'))); });
                }
            }
            if ($shapeBottom.length > 0) {
                ...
                if ($.isNumeric(bottomShapeSize)) { $sectionThis.find('.shapeBottom').css('height', 'calc(' + bottomShapeSize + '% + 5px)'); }
                ...
                if (bottomShapeColor.length > 0) { $sectionThis.find('.shapeBottom').css('fill', bottomShapeColor); } else {
                    $sectionThis.find('.shapeBottom').css('fill', GetShapeColor('bottom', $sectionThis.attr('id')));
                    $(document).on('s123.page.ready.refreshPageOrder', function(event) { $sectionThis.find('.shapeBottom').css('fill', GetShapeColor('bottom', $sectionThis.attr('id'))); });
                }
            }
            ...
            var promoScreenChangeHandler = new PromoScreenChangeHandler({ sectionID: $sectionThis.data('module-id'), $section: $sectionThis, });
        });
    });

    function PromoScreenChangeHandler(settings) {
        var _ = { sectionID: settings.sectionID, $section: settings.$section, $texts: {} };
        _.init = function() {
            _.$section.find('#' + _.sectionID + '-promoText1, #' + _.sectionID + '-promoText2, #' + _.sectionID + '-promoText3').each(function(index, promoText) {
                ...
                _.$texts[$promoText.get(0).id] = { $el: $promoText, orignialFontSize: $promoText.css('font-size') };
                _.fitFontSize($promoText);
            });
            if (IsWizard()) {
                $(document).off('wizard.preview.device.changed.promoScreenChangeHandler_' + _.sectionID).on('wizard.preview.device.changed.promoScreenChangeHandler_' + _.sectionID, function(event) { $.each(_.$texts, function(index, $text) { _.fitFontSize($text.$el); }); });
                _.$section.off('resizableText.end.promoScreenChangeHandler').on('resizableText.end.promoScreenChangeHandler', function(event, $el, newFontSize) { _.updateOriginalFontSize($el.get(0).id, newFontSize + 'px'); });
            }
        };
        _.fitFontSize = function($el) {
            if ($(window).width() >= 1) { $el.css('font-size', (parseFloat(_.$texts[$el.get(0).id].orignialFontSize) * $(window).width() / 1170 + 8) + 'px'); }
        ...
        _.updateOriginalFontSize = function(elemetID, newFontSize) { _.$texts[elemetID].orignialFontSize = newFontSize; };
        _.init();
        return _;
    }
...
function WidgetsModuleInitialize() {
    $(document).on('s123.page.ready', function(event) {
        ...
        $section.each(function(index) {
            ...
            if ($shapeBottom.length > 0) {
                ...
                if ($.isNumeric(bottomShapeSize)) { $sectionThis.find('.shapeBottom').css('height', 'calc(' + bottomShapeSize + '% + 5px)'); }
                if (bottomShapeHideFromMobile == 'on') { $sectionThis.find('.shapeBottom').attr('class', $sectionThis.find('.shapeBottom').attr('class') + ' hideFromMobile'); }
                if (bottomShapeColor.length > 0) { $sectionThis.find('.shapeBottom').css('fill', bottomShapeColor); } else { $sectionThis.find('.shapeBottom').css('fill', GetShapeColor('bottom', $sectionThis.attr('id'))); }
            }
            $sectionThis.find('.carousel').carousel();
            $sectionThis.find('.promoForm').each(function(index) {
                var $form = $(this);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if (clickAction == 'thankYouMessage' || clickAction == '') {
                                    ...
                                    bootbox.alert({ title: translations.sent, message: translations.ThankYouAfterSubmmit + '<iframe src="/versions/' + $('#versionNUM').val() + '/include/contactSentO.php?w=' + $('#w').val() + '&websiteID=' + dataObj.websiteID + '&moduleID=' + dataObj.moduleID + '&moduleTypeNUM=159&widgetID=' + widgetID + '&columnID=' + columnID + '&structureID=' + structureID + '" style="width:100%;height:30px;" frameborder="0"></iframe>', className: 'contactUsConfirm', buttons: { ok: { label: translations.Ok } }, backdrop: true });
                                } else {
                                    if (dataObj.conv_code.length > 0) {
                                        var $convCode = $('<div>' + dataObj.conv_code + '</div>');
                                        $convCodeContainer.html($convCode.text());
            ...
            var widgetsScreenChangeHandler = new WidgetsScreenChangeHandler({ sectionID: $sectionThis.data('module-id'), $section: $sectionThis, });
        });
    });
    ...
    function WidgetsScreenChangeHandler(settings) {
        ...
        _.init = function() {
            ...
            if (IsWizard()) {
                $(document).off('wizard.preview.device.changed.WidgetsScreenChangeHandler_' + _.sectionID).on('wizard.preview.device.changed.WidgetsScreenChangeHandler_' + _.sectionID, function(event) { $.each(_.$texts, function(index, $text) { _.fitFontSize($text.$el); }); });
                _.$section.off('resizableText.end.WidgetsScreenChangeHandler').on('resizableText.end.WidgetsScreenChangeHandler', function(event, $el, newFontSize) { _.updateOriginalFontSize($el.get(0).id, newFontSize + 'px'); });
                _.$section.off('widgetManager.add.WidgetsScreenChangeHandler').on('widgetManager.add.WidgetsScreenChangeHandler', function(event, $el) { _.refresh(); });
            }
        };
        _.refresh = function() {
            _.$section.find('.promoText').each(function(index, promoText) {
...
jQuery(function($) { PromoOldV1ModuleInitialize(); });
...
function CountdownWidget() {
    var CW = { translate: { days: 'Days', hours: 'Hours', minutes: 'Minutes', seconds: 'Seconds' } };
    CW.init = function(settings) {
        ...
        if (settings.translate) { $.each(settings.translate, function(index, value) { CW.translate[index] = value; }); }
        if (settings.onStop) { CW.onStop = settings.onStop; }
        var $html = CW.generateHTML();
        CW.items = { days: $html.find('.days .countdown-digits'), hours: $html.find('.hours .countdown-digits'), minutes: $html.find('.minutes .countdown-digits'), seconds: $html.find('.seconds .countdown-digits') };
    ...
    CW.generateHTML = function() {
        ...
        html += '</div>';
        var $html = $(html);
        if (CW.type == '2') { $html.find('.countdown-item.days').remove(); } else if (CW.type == '3') {
    ...
    CW.updateClock = function() {
        ...
        $.each(timer.parts, function(index, value) { if (CW.items[index].length) CW.items[index].html(value); });
        if (timer.total <= 0) {
    ...
    CW.splitNum = function(num) {
        ...
        $.each(digits, function(index, value) { countdownDigits += '<span class="countdown-digit">' + value + "</span>" });
        return countdownDigits
    }
    return CW;
}
jQuery(function($) { CountdownModuleInitialize(); });
...
function CountdownModuleInitialize() {
    $(document).on('s123.page.ready', function(event) {
        $('.s123-module-countdown-container').each(function() {
            ...
            FlipClock.Lang['manually'] = { 'years': translations.flipClock.years, 'months': translations.flipClock.months, 'days': translations.flipClock.days, 'hours': translations.flipClock.hours, 'minutes': translations.flipClock.minutes, 'seconds': translations.flipClock.seconds };
            $clock = $clock.FlipClock(diff, { clockFace: clockFace, autoStart: true, countdown: true, callbacks: { stop: function() { $message.css('visibility', 'visible'); } }, language: 'manually', });
        });
    });
}
...
function CountdownModuleInitialize_Layout3() {
    $(document).on('s123.page.ready', function(event) {
        ...
        $sections.each(function(index) {
            ...
            countdownWidget.init({ $countdown: $s.find('#countdown'), dateInfo: $countdown.data('date-info'), type: $countdown.data('type'), translate: { days: $countdown.data('days'), hours: $countdown.data('hours'), minutes: $countdown.data('minutes'), seconds: $countdown.data('seconds') }, onStop: function() { $s.find('.message').fadeIn(350); } });
        });
    });
}
jQuery(function($) { PercentageModuleInitialize_Layout1(); });
        ...
        $('.s123-module-percentage.layout-1').each(function() {
            ...
            $this.find('.easy-pie-chart').each(function() {
                $(this).appear(function() {
                    ...
                    if (parseFloat($(this).data('percent')) <= 0) { $(this).css({ width: chartSize, height: chartSize }); } else { $(this).easyPieChart({ barColor: $(this).data('custom-bar-color'), trackColor: false, scaleColor: false, lineWidth: 5, animate: 2000, size: chartSize }); }
                });
            });
        });
    });
        ...
        $(document).on('s123.css.reloaded', function(event) {
            $('.s123-module-percentage.layout-1').each(function() {
                ...
                $this.find('.easy-pie-chart[data-is-default-color="1"]').each(function() {
                    var barColor = getComputedStyle(document.documentElement).getPropertyValue($(this).data('custom-bar-color'));
...
jQuery(function($) { JobsModuleInitialize(); });
...
function JobsModuleInitialize() {
    $(document).on('s123.page.ready', function(event) {
        ...
        $section.each(function(index) {
            var $sectionThis = $(this);
            if (is_touch_device()) { $sectionThis.addClass('touch-device'); }
                ...
                $('#popupJobs').find('.jobsForm').each(function(index) {
                    ...
                    $form.validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            var bootboxDialog = bootbox.alert({ title: translations.sending, message: $jobsLoadingMessage, className: 'jobsConfirm, bootbox-jobs-form', backdrop: true }).on("hidden.bs.modal", function() { buildPopup_CloseAction('popupJobs'); });
                            $.ajax({
                                type: "POST",
...
jQuery(function($) { AutoSetProductsImage(); });
...
function AutoSetProductsImage_onImageReady(selector, handler, $imgBox, $thisModule) {
    ...
    list.each(function(index, element) {
        if (element.complete) {
            setTimeout(function() { fireHandler.call(element); }, 0); // Won't really be 0, but close
        } else { $(element).bind('load', fireHandler); }
    });
