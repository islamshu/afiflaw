...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(a) { "use strict"; var b = a.fn.jquery.split(" ")[0].split("."); if (b[0] < 2 && b[1] < 9 || 1 == b[0] && 9 == b[1] && b[2] < 1) throw new Error("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher") }(jQuery), + function(a) {
    ...
    d.VERSION = "3.3.2", d.TRANSITION_DURATION = 350, d.DEFAULTS = { toggle: !0, trigger: '[data-toggle="collapse"]' }, d.prototype.dimension = function() { var a = this.$element.hasClass("width"); return a ? "width" : "height" }, d.prototype.show = function() {
    ...
    c.VERSION = "3.3.2", c.TRANSITION_DURATION = 300, c.BACKDROP_TRANSITION_DURATION = 150, c.DEFAULTS = { backdrop: !0, keyboard: !0, show: !0 }, c.prototype.toggle = function(a) { return this.isShown ? this.hide() : this.show(a) }, c.prototype.show = function(b) {
        var d = this,
    ...
    }, c.prototype.handleUpdate = function() { this.options.backdrop && this.adjustBackdrop(), this.adjustDialog() }, c.prototype.adjustBackdrop = function() { this.$backdrop.css("height", 0).css("height", this.$element[0].scrollHeight) }, c.prototype.adjustDialog = function() {
        var a = this.$element[0].scrollHeight > document.documentElement.clientHeight;
        this.$element.css({ paddingLeft: !this.bodyIsOverflowing && a ? this.scrollbarWidth : "", paddingRight: this.bodyIsOverflowing && !a ? this.scrollbarWidth : "" })
    }, c.prototype.resetAdjustments = function() { this.$element.css({ paddingLeft: "", paddingRight: "" }) }, c.prototype.checkScrollbar = function() { this.bodyIsOverflowing = document.body.scrollHeight > document.documentElement.clientHeight, this.scrollbarWidth = this.measureScrollbar() }, c.prototype.setScrollbar = function() {
    ...
    b.VERSION = "3.3.2", b.DEFAULTS = { offset: 10 }, b.prototype.getScrollHeight = function() { return this.$scrollElement[0].scrollHeight || Math.max(this.$body[0].scrollHeight, document.documentElement.scrollHeight) }, b.prototype.refresh = function() {
        var b = "offset",
            c = 0;
...
(function(root, factory) { "use strict"; if (typeof define === "function" && define.amd) { define(["jquery"], factory); } else if (typeof exports === "object") { module.exports = factory(require("jquery")); } else { root.bootbox = factory(root.jQuery); } }(this, function init($, undefined) {
    ...
    exports.dialog = function(options) {
        ...
        if ($.fn.modal === undefined) {
            throw new Error("$.fn.modal is not defined; please double check you have included " + "the Bootstrap JavaScript library. See http://getbootstrap.com/javascript/ " +
                "for more details.");
        }
    ...
    var locales = { bg_BG: { OK: "ذ‍ذ؛", CANCEL: "ذ‍ر‚ذ؛ذ°ذ·", CONFIRM: "ذںذ¾ر‚ذ²رٹر€ذ¶ذ´ذ°ذ²ذ°ذ¼" }, br: { OK: "OK", CANCEL: "Cancelar", CONFIRM: "Sim" }, cs: { OK: "OK", CANCEL: "Zruإ،it", CONFIRM: "Potvrdit" }, da: { OK: "OK", CANCEL: "Annuller", CONFIRM: "Accepter" }, de: { OK: "OK", CANCEL: "Abbrechen", CONFIRM: "Akzeptieren" }, el: { OK: "خ•خ½د„خ¬خ¾خµخ¹", CANCEL: "خ‘خ؛دچدپد‰دƒخ·", CONFIRM: "خ•د€خ¹خ²خµخ²خ±خ¯د‰دƒخ·" }, en: { OK: "OK", CANCEL: "Cancel", CONFIRM: "OK" }, es: { OK: "OK", CANCEL: "Cancelar", CONFIRM: "Aceptar" }, et: { OK: "OK", CANCEL: "Katkesta", CONFIRM: "OK" }, fa: { OK: "ظ‚ط¨ظˆظ„", CANCEL: "ظ„ط؛ظˆ", CONFIRM: "طھط§غŒغŒط¯" }, fi: { OK: "OK", CANCEL: "Peruuta", CONFIRM: "OK" }, fr: { OK: "OK", CANCEL: "Annuler", CONFIRM: "D'accord" }, he: { OK: "×گ×™×©×•×¨", CANCEL: "×‘×™×ک×•×œ", CONFIRM: "×گ×™×©×•×¨" }, hu: { OK: "OK", CANCEL: "Mأ©gsem", CONFIRM: "Megerإ‘sأ­t" }, hr: { OK: "OK", CANCEL: "Odustani", CONFIRM: "Potvrdi" }, id: { OK: "OK", CANCEL: "Batal", CONFIRM: "OK" }, it: { OK: "OK", CANCEL: "Annulla", CONFIRM: "Conferma" }, ja: { OK: "OK", CANCEL: "م‚­مƒ£مƒ³م‚»مƒ«", CONFIRM: "ç¢؛èھچ" }, lt: { OK: "Gerai", CANCEL: "Atإ،aukti", CONFIRM: "Patvirtinti" }, lv: { OK: "Labi", CANCEL: "Atcelt", CONFIRM: "Apstiprinؤپt" }, nl: { OK: "OK", CANCEL: "Annuleren", CONFIRM: "Accepteren" }, no: { OK: "OK", CANCEL: "Avbryt", CONFIRM: "OK" }, pl: { OK: "OK", CANCEL: "Anuluj", CONFIRM: "Potwierdإ؛" }, pt: { OK: "OK", CANCEL: "Cancelar", CONFIRM: "Confirmar" }, ru: { OK: "OK", CANCEL: "ذ‍ر‚ذ¼ذµذ½ذ°", CONFIRM: "ذںر€ذ¸ذ¼ذµذ½ذ¸ر‚رŒ" }, sq: { OK: "OK", CANCEL: "Anulo", CONFIRM: "Prano" }, sv: { OK: "OK", CANCEL: "Avbryt", CONFIRM: "OK" }, th: { OK: "à¸•à¸پà¸¥à¸‡", CANCEL: "à¸¢à¸پà¹€à¸¥à¸´à¸پ", CONFIRM: "à¸¢à¸·à¸™à¸¢à¸±à¸™" }, tr: { OK: "Tamam", CANCEL: "ؤ°ptal", CONFIRM: "Onayla" }, zh_CN: { OK: "OK", CANCEL: "هڈ–و¶ˆ", CONFIRM: "ç،®è®¤" }, zh_TW: { OK: "OK", CANCEL: "هڈ–و¶ˆ", CONFIRM: "ç¢؛èھچ" } };
